  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        <p className="num text-6xl font-semibold text-foreground">404</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Atlas — Property Operations Console" },
      {
        name: "description",
        content: "Atlas is the operating console for modern property portfolios.",
      },
    ...
    <QueryClientProvider client={queryClient}>
      <ThemeProvider>
        <div className="min-h-dvh bg-background">
          <TopNav onOpenPalette={() => setOpen(true)} />
